...
def replicate_string(string, n):
    ...
    modified_string = replace_spaces_with_underscore(string)
    replicated_string = (modified_string + '_') * (n - 1) + modified_string if n > 0 else modified_string
    return replicated_string